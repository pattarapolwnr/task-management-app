...
const Task = ({ title, description, status }: TaskProps): React.JSX.Element => {
  return (
    <>
      <div className="flex justify-center items-center flex-col w-96 min-h-28 md:max-h-60 md:w-[600px] overflow-hidden">
        {/* Content */}
        <div className="flex justify-center items-center space-x-6 md:space-x-10">
          ...
          <div className="flex w-60 md:w-72 flex-col justify-start items-center">
            ...
            {/* Description */}
            <p className="w-60 md:w-72 font-light text-xs text-gray-400 md:text-sm">
              {description}
            </p>
          </div>
        </div>
